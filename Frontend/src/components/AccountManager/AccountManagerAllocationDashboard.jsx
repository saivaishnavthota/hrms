...
const AccountManagerAllocationDashboard = () => {
  ...
  const fetchAllEmployees = async () => {
    try {
      setLoading(true);
      // Account Manager gets all employees
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="font-body-md text-gray-600 mt-1" style={{ fontFamily: 'Arial, sans-serif' }}>View project allocations for all employees</p>
          </div>
...
export default AccountManagerAllocationDashboard;
