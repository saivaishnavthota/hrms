...
const DocumentCollection = () => {
  ...
  const [sampleEmployeesData] = useState([
    {
      id: 1,
      name: 'John Smith',
      ...
      documents: [
        { id: 1, name: 'Resume', type: 'PDF', status: 'approved', uploadDate: '2024-01-15', size: '2.3 MB' },
        { id: 2, name: 'ID Proof', type: 'PDF', status: 'pending', uploadDate: '2024-01-16', size: '1.8 MB' },
        { id: 3, name: 'Address Proof', type: 'PDF', status: 'rejected', uploadDate: '2024-01-17', size: '2.1 MB' },
        { id: 4, name: 'Education Certificate', type: 'PDF', status: 'approved', uploadDate: '2024-01-18', size: '3.2 MB' },
        { id: 5, name: 'Experience Letter', type: 'PDF', status: 'pending', uploadDate: '2024-01-19', size: '1.5 MB' },
        { id: 6, name: 'Medical Certificate', type: 'PDF', status: 'approved', uploadDate: '2024-01-20', size: '2.8 MB' },
        { id: 7, name: 'Bank Statement', type: 'PDF', status: 'pending', uploadDate: '2024-01-21', size: '4.1 MB' },
        { id: 8, name: 'Passport Copy', type: 'PDF', status: 'approved', uploadDate: '2024-01-22', size: '1.9 MB' },
        { id: 9, name: 'PAN Card', type: 'PDF', status: 'rejected', uploadDate: '2024-01-23', size: '1.2 MB' },
        { id: 10, name: 'Aadhar Card', type: 'PDF', status: 'approved', uploadDate: '2024-01-24', size: '1.7 MB' },
        { id: 11, name: 'Salary Slip', type: 'PDF', status: 'pending', uploadDate: '2024-01-25', size: '2.4 MB' },
        { id: 12, name: 'Offer Letter', type: 'PDF', status: 'approved', uploadDate: '2024-01-26', size: '1.6 MB' },
        { id: 13, name: 'NOC Certificate', type: 'PDF', status: 'pending', uploadDate: '2024-01-27', size: '2.0 MB' },
        { id: 14, name: 'Portfolio', type: 'PDF', status: 'approved', uploadDate: '2024-01-28', size: '5.3 MB' },
        { id: 15, name: 'References', type: 'PDF', status: 'rejected', uploadDate: '2024-01-29', size: '1.4 MB' },
        { id: 16, name: 'Contract Agreement', type: 'PDF', status: 'approved', uploadDate: '2024-01-30', size: '3.7 MB' }
      ]
    },
    {
      id: 2,
      ...
      documents: [
        { id: 1, name: 'Resume', type: 'PDF', status: 'approved', uploadDate: '2024-01-10', size: '2.1 MB' },
        { id: 2, name: 'Portfolio', type: 'PDF', status: 'approved', uploadDate: '2024-01-11', size: '8.5 MB' },
        { id: 3, name: 'ID Proof', type: 'PDF', status: 'pending', uploadDate: '2024-01-12', size: '1.9 MB' },
        { id: 4, name: 'Address Proof', type: 'PDF', status: 'approved', uploadDate: '2024-01-13', size: '2.3 MB' },
        { id: 5, name: 'Education Certificate', type: 'PDF', status: 'approved', uploadDate: '2024-01-14', size: '3.1 MB' },
        { id: 6, name: 'Experience Letter', type: 'PDF', status: 'approved', uploadDate: '2024-01-15', size: '1.7 MB' },
        { id: 7, name: 'Medical Certificate', type: 'PDF', status: 'pending', uploadDate: '2024-01-16', size: '2.6 MB' },
        { id: 8, name: 'Bank Statement', type: 'PDF', status: 'approved', uploadDate: '2024-01-17', size: '3.8 MB' },
        { id: 9, name: 'Passport Copy', type: 'PDF', status: 'approved', uploadDate: '2024-01-18', size: '2.0 MB' },
        { id: 10, name: 'PAN Card', type: 'PDF', status: 'approved', uploadDate: '2024-01-19', size: '1.3 MB' },
        { id: 11, name: 'Aadhar Card', type: 'PDF', status: 'approved', uploadDate: '2024-01-20', size: '1.8 MB' },
        { id: 12, name: 'Salary Slip', type: 'PDF', status: 'pending', uploadDate: '2024-01-21', size: '2.2 MB' }
      ]
    },
    {
      id: 3,
      ...
      documents: [
        { id: 1, name: 'Resume', type: 'PDF', status: 'approved', uploadDate: '2024-01-05', size: '2.4 MB' },
        { id: 2, name: 'ID Proof', type: 'PDF', status: 'approved', uploadDate: '2024-01-06', size: '1.6 MB' },
        { id: 3, name: 'Address Proof', type: 'PDF', status: 'rejected', uploadDate: '2024-01-07', size: '2.0 MB' },
        { id: 4, name: 'Education Certificate', type: 'PDF', status: 'approved', uploadDate: '2024-01-08', size: '3.5 MB' },
        { id: 5, name: 'Experience Letter', type: 'PDF', status: 'approved', uploadDate: '2024-01-09', size: '1.8 MB' },
        { id: 6, name: 'Medical Certificate', type: 'PDF', status: 'pending', uploadDate: '2024-01-10', size: '2.7 MB' },
        { id: 7, name: 'Bank Statement', type: 'PDF', status: 'approved', uploadDate: '2024-01-11', size: '4.2 MB' },
        { id: 8, name: 'Contract Agreement', type: 'PDF', status: 'pending', uploadDate: '2024-01-12', size: '3.9 MB' }
      ]
    }
  ]);
