...
const EmployeeAttendance = () => {
  ...
  useEffect(() => {
    const sampleRecords = [
      {
        id: 1,
        employee: { name: 'John Doe', email: 'john.doe@company.com' },
        type: 'Full Time',
        ...
        projects: [
          {
            ...
            subtasks: ['Frontend Development', 'API Integration', 'Code Review']
          },
          {
            name: 'Mobile App',
            subtasks: ['React Native Setup', 'Authentication Module']
          }
        ]
      },
      {
        id: 2,
        employee: { name: 'Jane Smith', email: 'jane.smith@company.com' },
        type: 'Full Time',
        ...
        projects: [
          {
            name: 'Q1 Campaign',
            subtasks: ['Campaign Planning', 'Content Creation', 'Budget Analysis']
          },
          {
            name: 'Brand Strategy',
            subtasks: ['Client Meeting', 'Market Research']
          }
        ]
      },
      {
        id: 3,
        employee: { name: 'Mike Johnson', email: 'mike.johnson@company.com' },
        type: 'Part Time',
        ...
        projects: [
          {
            ...
            subtasks: ['Cold Calling', 'Email Outreach', 'LinkedIn Prospecting']
          }
        ]
      },
      {
        id: 4,
        employee: { name: 'Sarah Wilson', email: 'sarah.wilson@company.com' },
        type: 'Contract',
        role: 'UI/UX Designer',
        day: 'Monday',
        date: '2025-01-20',
      ...
      {
        id: 5,
        employee: { name: 'David Brown', email: 'david.brown@company.com' },
        type: 'Full Time',
        ...
        projects: [
          {
            ...
            subtasks: ['Team Standup', 'Sprint Planning', 'Performance Review']
          },
          {
            name: 'Client Relations',
            subtasks: ['Client Review', 'Requirement Gathering']
          },
          {
            name: 'Process Improvement',
            subtasks: ['Workflow Optimization', 'Tool Evaluation']
          }
        ]
      }
    ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      {/* Modal for Projects and Subtasks */}
          ...
          <div className="bg-gradient-to-br from-white via-gray-50 to-blue-50 rounded-xl shadow-2xl max-w-3xl w-full mx-4 max-h-[80vh] overflow-y-auto border border-gray-200">
            <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-gray-600 to-blue-600 rounded-t-xl">
              <h3 className="text-xl font-semibold text-white">
                Employee Details - {viewRecord.employee.name}
              </h3>
              <button
