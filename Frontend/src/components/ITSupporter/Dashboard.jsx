...
import { getAssets, getAllocations, getMaintenanceRecords } from '../../lib/api';
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        setAllocated(allocationsRes.length || 0);
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-semibold text-gray-900">
              {showEmployeeView ? 'Activity Dashboard' : 'Assets Dashboard'}
            </h1>
            <p className="text-sm text-gray-500 mt-1">
              {showEmployeeView
                ? 'Overview of your attendance, leaves, and documents.'
