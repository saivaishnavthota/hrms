...
export default function Login() {
  ...
  style={{ backgroundImage: "url('/media/images/Media.jpeg')" }}
>
      {/* Gradient Overlay */}
      {/* <div className="absolute inset-0 bg-gradient-to-r from-slate-900/80 via-slate-900/60 to-slate-900/80"></div> */}

      {/* Login Form Container */}
      <div className="relative z-10 w-full  max-w-md p-8 bg-black-900/60 backdrop-blur-xl rounded-3xl shadow-2xl mx-4">
        {/* Logo */}
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-32 h-20  rounded-3xl mb-6 shadow-2xl">
            <img 
